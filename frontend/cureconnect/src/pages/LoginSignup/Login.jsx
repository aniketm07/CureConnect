  ...
  const storeUser = async (token) => {
    try {
      ...
      if (userData.role === "patient") {
        ...
        const doctor = await doctorService.fetchDoctorDetails(userData.id,token)
                ...
                <div className="w-full md:w-1/2 lg:w-1/2 flex justify-center items-center relative">
                  <div className="input_box w-4/5 md:w-330px">
                    <div className="flex flex-col md:flex-row justify-between items-center mb-10 ">
                      ...
                      <label className="inline-flex items-center cursor-pointer darkPrimary">
                        <span
                          className="mr-3 text-lg font-medium text-gray-900 dark:text-secondaryColor"
                          value="Patient"
                        >
                          Patient
                        </span>
                        ...
                        />
                        <div
                          className="relative w-11 h-6 bg-gray-400 rounded-full peer dark:bg-gray-700 
                                ...
                                after:transition-all peer-checked:bg-teal-600"
                        ></div>
                        <span
                          className="ms-3 text-lg font-medium dark:text-secondaryColor md:ml-3 md:mr-3"
                          value="Doctor"
                        >
                          Doctor
                        </span>
